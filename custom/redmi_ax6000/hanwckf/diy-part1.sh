...
sed -i '$a src-git luci https://github.com/kenzok8/openwrt-packages' feeds.conf.default
sed -i '$a src-git luci https://github.com/kenzok8/small' feeds.conf.default
git pull
./scripts/feeds update -a
